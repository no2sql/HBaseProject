...
public class BulkLoaderFatIdOld extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		try {
			...
			*/
			...
			job.setJarByClass(BulkLoaderFatIdOld.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			ToolRunner.run(new BulkLoaderFatIdOld(), args);
