...
public class Aggregate extends QueryBase {
    ...
    public static void main(String[] args) throws IOException, ParseException {
		...
		if (args.length > 0)
			new Aggregate(args[0], args[1]).execute();
		else
			new Aggregate(null, null).execute();		
	}
    
    public Aggregate(String startDate, String endDate) throws ParseException
	{
