...
public class BulkLoaderFatByteCache extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		try {
			...
			*/
			...
			job.setJarByClass(BulkLoaderFatByteCache.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			ToolRunner.run(new BulkLoaderFatByteCache(), args);
