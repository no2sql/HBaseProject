...
public class BulkLoaderFat extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		try {
			...
			*/
			...
			job = new Job(conf);
			job.setJobName("Bulk loader by file test_fat");			

			job.setMapOutputKeyClass(ImmutableBytesWritable.class);
			job.setMapOutputValueClass(Put.class);

			job.setMapperClass(BulkLoaderByFileMapper.class);
			job.setJarByClass(BulkLoaderFat.class);
	        ...
	        HFileOutputFormat.configureIncrementalLoad(job, new HTable(hConfig, "test_fat"));
	...
	public static void main(String[] args) {
		...
		try {
			...
			ToolRunner.run(new BulkLoaderFat(), args);
	...
	throws IOException, ParseException {
	  try {
		  ...
		  try{
			  admin.disableTable(Bytes.toBytes("test_fat"));
			  admin.deleteTable(Bytes.toBytes("test_fat"));
		  }
		  catch (Exception e) {
			  e.printStackTrace();
		  ...
		  HTableDescriptor table = new HTableDescriptor(Bytes.toBytes("test_fat"));
