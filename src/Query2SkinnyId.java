...
public class Query2SkinnyId extends QueryBase {
    ...
    public static class Mapper2 extends TableMapper</*BytesWritable*/Text, IntWritable> {
        ...
        public void map(ImmutableBytesWritable row, Result value, Context context) throws IOException {
        	...
        	try {
        		...
        		combo.set(rowVal.substring(0,rowVal.length()-1));
    ...
    public static void main(String[] args) throws IOException, ParseException {
    	...
    	Query2SkinnyId query = null;
		if (args.length > 0)
			query = new Query2SkinnyId(args[0], args[1]);
		else
			query = new Query2SkinnyId(null, null);
		
		query.setSkinnyTable();
		query.execute();
	}
    
    public Query2SkinnyId(String startDate, String endDate) throws ParseException
	{
	...
	protected String getResultTableName() {
		return "query2_skinny_id_result";
	}
