...
public class Query6SkinnyId extends QueryBase {
    ...
    public static void main(String[] args) throws IOException, ParseException {
		...
		if (args.length > 0)
			new Query6SkinnyId(args[0], args[1]).execute();
		else
			new Query6SkinnyId(null, null).execute();		
	}
    
    public Query6SkinnyId(String startDate, String endDate) throws ParseException
	{
	...
	protected String getResultTableName() {
		return "query6_skinny_id_result";
	}

	@Override
	protected String getInputTableName() {
		return "test_skinny_id_bigger";
	}
