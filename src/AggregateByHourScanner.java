...
public class AggregateByHourScanner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HTable htable = new HTable(conf, "aggregate_by_hour");
    	...
    	String keyRegex = "^.{" + Bytes.SIZEOF_LONG + "}" /* day */+ Bytes.toString(new byte[]{(byte)1}) + "{1}" /* parent or not */;
